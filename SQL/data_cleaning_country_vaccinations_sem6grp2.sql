...
CREATE TABLE country_vaccinations_sem6_grp2 AS SELECT * FROM country_vaccinations;
...
UPDATE country_vaccinations_sem6_grp2 SET date = STR_TO_DATE(date, '%c/%e/%Y');
...
SELECT COLUMN_NAME, DATA_TYPE from INFORMATION_SCHEMA.COLUMNS
WHERE table_name = "country_vaccinations_sem6_grp2";
