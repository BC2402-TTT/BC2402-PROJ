...
CREATE TABLE dim_country AS SELECT 
	location, iso_code, continent, /*tests_units,*/ population, population_density, median_age, aged_65_older, aged_70_older
...
# Drop related columns from country_vaccinations
